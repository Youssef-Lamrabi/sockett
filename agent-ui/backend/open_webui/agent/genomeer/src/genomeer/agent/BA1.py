...
from genomeer.utils.resources import data_lake_dict, library_content_dict, runtime_envs_dicts
...
# from genomeer.tools.support_tools import run_python_repl
...
class BioAgent:
    ...
    def _generate_system_prompt(
        ...
        formatted_prompt += """
        Important: In each response, you must include EITHER <execute> or <solution> tag. Not both at the same time. Do not respond with messages without any tags. No empty messages. Dont try to call automatically any tools. for tools call always genrate code in <execute></execute> tag.
        Important: Never ever try to invoke tools automatically from the model. use <execute></execute> in case.
        Important: for you response use <execute>…</execute>, <observation>…</observation>, <solution>…</solution>, <think>…</think>. i dont considere any text ouside.
        """
