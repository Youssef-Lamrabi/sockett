...
3. Lastly, to activate the genomeer environment:
```bash
...
```bash
conda activate btools_env_py310
```

### 📦 Langchain Package Support

The bioTools environment comes with a minimal set of langchain packages by default:
