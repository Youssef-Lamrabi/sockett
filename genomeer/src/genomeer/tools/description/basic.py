description = [
    ...
    {
        "name": "translate_orfs",
        "description": "Find ORFs and translate to proteins (both strands optional).",
        "required_parameters": [
    ...
    },
    {
        ...
        "description": "Toy functional annotation (all proteins labeled unknown_function).",
        "required_parameters": [
    ...
    },
    {
        ...
        "description": "Very simple greedy baseline assembler (toy concat).",
        "required_parameters": [
            {"name": "reads", "type": "list"},
