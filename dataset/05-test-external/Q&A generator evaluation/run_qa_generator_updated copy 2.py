...
"""
    ...
    for i, qa in enumerate(initial, 1):
        ...
        try:
            ...
            # )
            followup = call_model(
    system="""You generate deeper technical questions for LLM training.
Follow-up questions must:
- Increase technical depth
- Stay domain-general
- Remain answerable from the text
- NOT mention papers or studies
""",
    user=f"""
BASE QUESTION:
{qa["question"]}
...
Generate ONE deeper technical question that probes
implementation details, assumptions, or parameters.
