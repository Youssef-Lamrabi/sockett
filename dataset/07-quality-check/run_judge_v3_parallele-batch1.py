# v2: ONE/MANY METRIC, PARALLELE DATA AT TIME
...
INPUT_PATHS = [
    ...
    "/mnt/nfs/llmhub/Genomeer/dataset/06-quality-check/input/dataset/db_2/qa_conceptual/factual_remaining_batch1.jsonl",
    
    #"/mnt/nfs/llmhub/Genomeer/dataset/06-quality-check/input/dataset/db_2/qa_workflows/workflow.jsonl",
]

OUTPUT_DIR = "/mnt/nfs/llmhub/Genomeer/dataset/06-quality-check/input/scored"
...
FIELD_MAP = {
    ...
    "github.jsonl": {
        ...
        "answer": ["output"],
        "source": {
            "initial_question": "metadata.raw_input",
            "initial_answer": "metadata.raw_responses",
        }
    },
    "conceptual.jsonl": {
        "question": ["question"],
...
def process_file(input_path):
    ...
    with open(out_path, "a") as outfile:
        with ThreadPoolExecutor(max_workers=4) as executor:
            ...
            futures = [executor.submit(process_line, line, config) for line in lines]
            for future in tqdm(as_completed(futures), total=total_lines, desc=f"Processing {filename}"):
